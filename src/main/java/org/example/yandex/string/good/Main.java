package org.example.yandex.string.good;
...
public class Main {
     ...
     * с написанными на них буквами латинского алфавита. Теперь-то ему будет чем заняться
     ...
     * Например, хорошесть строки "abcdefghijklmnopqrstuvwxyz" равна 25,
     * а строки "abdc" — только 1.
     *
     * Ипполит размышляет над решением закономерно возникающей задачи: чему равна
     * максимально возможная хорошесть строки, которую можно собрать, используя дощечки
     * из данного набора? Вы-то и поможете ему с ней справиться.
     *
     * Формат ввода
     * Первая строка ввода содержит единственное целое число N — количество различных букв
     * в наборе (1 <= N <= 26). Обратите внимание: в наборе всегда используются N первых
     * букв латинского алфавита.
     *
     * Следующие N строк содержат целые положительные числа c_i — количество букв
     * соответствующего типа (1 <= c_i <= 10^9). Таким образом, первое число означает
     ...
     *
     * Примечание
     * В первом тесте имеется по одной дощечке с каждой из 3 различных букв.
     * Ответ 2 достигается на строке "abc".
     */
